...
const AppropriationPage = () => {
  return (
    <>
      <main id="landingPage" className="flex flex-col md:flex-row min-w-full min-h-[75vh] justify-center items-center py-0 m-0 bg-black">
        ...
        <div className='flex z-40 flex-col w-full bg-transparent p-4 text-center items-center justify-center'>
          ...
          <div className='text-white mb-7 text-xl'>
            Um pouco sobre o módulo de <span className='font-bold'>Apropriação</span>
          </div>
