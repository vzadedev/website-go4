          ...
          <div className="grid lg:gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-3 text-lg text-gray-600 text-center sm:text-left">
                O Mapa de Jornada oferece uma visão clara e detalhada de INICIO e FIM das operações de cada
                veículo / frota. Com ele, é possível acompanhar a hora que se deu a IGNIÇÃO ON e OFF,
                identificando de forma simples e pratica o início e fim de JORNADA de cada ATIVO.
              </p>
            </div>
            <div aria-hidden="true" className="mt-10 lg:mt-0">
              <img
