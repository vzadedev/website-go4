...
const Brief = () => {
  ...
  return (
    <main id="brief" className="min-h-fit w-full h-fit-content flex flex-col items-center justify-center m-0 bg-white">
      
      <div className="min-w-screen flex items-center justify-center py-8">
          <div className="w-full bg-white px-5 text-gray-800">
            <div className="w-full max-w-6xl mx-auto">
              <div className="text-center max-w-xl mx-auto">
                <h1 className="text-3xl font-bold mb-5 text-gray-600">Depoimentos de parceiros</h1>
                <div className="text-center mb-10">
                  <span className="inline-block w-1 h-1 rounded-full bg-primary-light ml-1"></span>
                  <span className="inline-block w-3 h-1 rounded-full bg-primary-light ml-1"></span>
                  <span className="inline-block w-40 h-1 rounded-full bg-primary-light"></span>
                  <span className="inline-block w-3 h-1 rounded-full bg-primary-light ml-1"></span>
                  <span className="inline-block w-1 h-1 rounded-full bg-primary-light ml-1"></span>
                </div>
              </div>
              <div className="-mx-3 md:flex items-start">
                <div className="px-3 md:w-1/3">
                  ...
                  <div className="w-full mx-auto hover:scale-105 hover:drop-shadow-theme transition-all duration-500 ease-in-out cursor-pointer rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-6">
